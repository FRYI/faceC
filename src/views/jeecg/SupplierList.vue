        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="pin">
              <a-input placeholder="请输入pin" v-model="queryParam.pin"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="scope">
                <a-input placeholder="请输入最小值" class="query-group-cust" v-model="queryParam.scope_begin"></a-input>
                <span class="query-group-split-cust"></span>
                <a-input placeholder="请输入最大值" class="query-group-cust" v-model="queryParam.scope_end"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
