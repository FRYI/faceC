<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="10" :lg="11" :md="12" :sm="24">
            <a-form-item label="torder">
              <a-input placeholder="please enter 最小值" class="query-group-cust" v-model="queryParam.torder_begin"></a-input>
              <span class="query-group-split-cust"></span>
              <a-input placeholder="please enter 最大值" class="query-group-cust" v-model="queryParam.torder_end"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="10" :lg="11" :md="12" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="status">
                <a-input placeholder="please enter 最小值" class="query-group-cust" v-model="queryParam.status_begin"></a-input>
                <span class="query-group-split-cust"></span>
                <a-input placeholder="please enter 最大值" class="query-group-cust" v-model="queryParam.status_end"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('torderstatus')">导出</a-button>
    ...
    <torderstatus-modal ref="modalForm" @ok="modalFormOk"></torderstatus-modal>
  </a-card>
</template>
...
<script>
  ...
  import TorderstatusModal from './modules/TorderstatusModal'
  import JDate from '@/components/jeecg/JDate.vue'

  export default {
    name: "TorderstatusList",
    ...
    data () {
      return {
        description: 'torderstatus管理page面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/torderstatus/torderstatus/list",
          delete: "/torderstatus/torderstatus/delete",
          deleteBatch: "/torderstatus/torderstatus/deleteBatch",
          exportXlsUrl: "/torderstatus/torderstatus/exportXls",
          importExcelUrl: "torderstatus/torderstatus/importExcel",
        },
        dictOptions:{},
      }
    },
