    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="season" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input  v-decorator="['season']" placeholder="please enter season"></a-input>
        </a-form-item>
        ...
        <a-form-item label="depositeDate" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="please enter deposite Date" v-decorator="['depositeDate']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="comfirmDate" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="please enter comfirm Date" v-decorator="['comfirmDate']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="inspection Date" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="please enter inspection Date" v-decorator="['inspectionDate']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="deliveryDate" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="please enter delivery Date" v-decorator="['deliveryDate']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
