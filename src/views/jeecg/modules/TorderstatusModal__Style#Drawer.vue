  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/torderstatus/torderstatus/add",
          edit: "/torderstatus/torderstatus/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'torder','date','status','createTime','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'torder','date','status','createTime','updateTime'))
      }
